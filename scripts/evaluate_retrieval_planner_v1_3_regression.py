...
def main() -> None:
    ...
    payload = {
        ...
        "baseline_before_planner_1_3": {
            ...
            "scope_exact": baseline["scope_exact_with_planner_1_2"],
            "temporal_exact": baseline["temporal_exact_with_planner_1_2"],
            "joint_exact": baseline["joint_route_scope_temporal_exact"],
            "remaining_joint_error_ids": baseline["remaining_joint_error_ids"],
        },
        "governance": {
